...
VkInstance createInstance() 
{
	...
	createInfo.enabledExtensionCount = sizeof(debugLayers) / sizeof(debugLayers[0]);
#endif 
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(800, 600, "Vulkan", 0, 0);
	assert(window);
